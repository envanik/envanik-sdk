...
JavaScript SDK designed to interact with Envnik DEX.

## How to run the examples (Javascript)?

**In order to run the examples provided, please follow the below steps:**

1. git clone https://github.com/envanik/envanik-sdk.git && cd envanik-sdk/balancer-js
...
```js
import { BalancerSDK, BalancerSdkConfig, Network } from '@envanik-dex/sdk';
...
The Envanik Vault provides a [method to simulate join or exit calls to a pool](https://github.com/balancer-labs/balancer-v2-monorepo/blob/master/pkg/standalone-utils/contracts/BalancerQueries.sol#L91).
